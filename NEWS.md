...
# Changes in version traceR 0.2.0
...
3. Added new
function `tr_default()` that keeps RAW and META data and deletes
everything else from the object. 
4. Argument `what` is now supports
regular expressions on meta data content.
